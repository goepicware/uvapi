    ...
    for($s=0;$s<count($files);$s++){
        ...
        echo "
         <td style=\"background:#ffffff;margin:5px\">
            <center>
            <img src='".getFullUrl()."/".$folder."/".$files[$s]."' width=\"100\" height=\"100\" border=0 >
            </center>
...
<script>
    ...
    $('.button').click(function(){
        ...
        $.ajax({
            url: 'https://ccpl.ninjaos.com/drag-drop-editor/media-popup.php?op=newfile',  //Server script to process data
            type: 'POST',
    ...
    function loadimages(){
        ...
        var request = $.ajax({
            url: "https://ccpl.ninjaos.com/drag-drop-editor/media-popup.php?immagini=1",
            method: "POST",
            data: { nome : '' },
            dataType: "html"
        });
