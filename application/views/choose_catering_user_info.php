...
<div class="event-com-bottom select-outlet controls">
	...
	<ul>
	  <?php foreach($corporate_user_contact_list as $user_contact_list){ ?>
		<li class="select_banana_halls <?php echo ($this->session->userdata('corporate_order_email_address') == $user_contact_list->corp_email) ? "user_active_flag" : "";?>" data-id="<?php echo $user_contact_list->corp_cust_id; ?>">
...
<span class="success_div_cls" id="contact_details" style="color:green; display:block;" ></span>
