...
<table class="responsive_w" width="100%" style="background:#fff; max-width: 600px; margin:10px auto; -webkit-text-size-adjust:none; border-collapse: collapse; font-family: arial, sans-serif; font-size: 12px;">
    ...
    <tr>
        <td width="50%">
            ...
            if ($order_list[0]['client_invoice_main_logo'] !='' && file_exists(FCPATH . "media/" . $order_list[0]['client_folder_name'] . "/" . $folder . "/" . $order_list[0]['client_invoice_main_logo'])) {
                ?>
                <img src="<?php echo base_url() . "media/" . $order_list[0]['client_folder_name'] . "/" . $folder . "/" . $order_list[0]['client_invoice_main_logo']; ?>" alt="logo" />
            <?php } ?>
        </td>
        <td width="50%">
                ...
                <tr>
                    <td style="text-transform: uppercase;font-weight:normal;color:#787878;font-family: arial, sans-serif;  font-size:12px;text-align: right;">DATE OF ORDER: 
                        <span style="font-weight:bold;color:#000;">
                            <?php echo get_date_formart($order_list[0]['order_created_on'], 'd-m-y h:i:s') ?>
                        </span>
                    </td>
                </tr>
            </table>
            ...
            <table width="100%" style="font-family: arial, sans-serif; font-size:12px;">
                <tr>
                    <td style="font-weight:bold; color:#000; font-family: arial, sans-serif; font-size:12px;"><strong><?php echo stripslashes(ucwords($order_list[0]['customer_name'])); ?> 
                            <?php echo "<br>" . show_address_format($order_list[0]['order_customer_address_line1'], $order_list[0]['order_customer_address_line2'], " ", " "). " ".$order_list[0]['order_customer_postal_code']; ?>
                        </strong>
                    </td>
                </tr>
                <tr>
            ...
            <table  cellpadding="5" cellspacing="0" width="100%" style="font-family: arial, sans-serif; font-size:12px;border:1px solid #b5b5b5; border-collapse: collapse; ">
                ...
                <?php foreach ($oder_item as $item) { ?>
                    ...
                    <tr>
                        ...
                        <td style="color:#787878; font-family: arial, sans-serif; font-size:12px; padding:7px; text-align: left; border: 1px solid #b5b5b5;">
                            ...
                            <?php if (!empty($item['addons_order'])) { ?>  
                                ...
                                <?php foreach ($item['addons_order'] as $addons_order) { ?>		<?php if ($addons_order['oa_addons_qty'] != '0') { ?>
                                    <tr>
                                        <td>
                                            <?php echo $addons_order['oa_addons_qty']; ?> X  <?php echo $addons_order['oa_addons_name']; ?><?php echo "(+ " . show_price($addons_order['oa_addons_price']) . ")"; ?>
                                        </td>
                                    </tr> 
                            ...
                            <?php if (!empty($item['setup_order'])) { ?>  
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <?php echo "(+ ".show_price($item['setup_order'][0]['os_setup_price']).")";?>
                                    </td>
                                </tr>                                
                                    ...
                                    <?php if ($equipment_order['oe_equipment_qty'] != '0') { ?>					     
                                        <tr>
                                            <td>
                                                ...
                                                <?php echo "(+ " . show_price($equipment_order['oe_equipment_price']) . ")"; ?>
                                            </td>
                                        </tr>
                        ...
                        <td style="color:#787878; font-family: arial, sans-serif; font-size:12px; padding:7px;text-align: center; border: 1px solid #b5b5b5;">
                            <?php echo show_price($item['item_total_amount']); ?>
                        </td>
                    </tr>
                ...
                <tr bgcolor="#f3f3f3">
                    ...
                    <td colspan="1" style="    color: #000;	font-family: arial, sans-serif;	font-size: 12px;	padding: 7px;	 text-align: right; font-weight:600;border: 1px solid #b5b5b5; "><strong><?php echo show_price($order_list[0]['order_sub_total']); ?></strong></td>
                </tr>
                    ...
                    <?php if ($order_list[0]['order_availability_name'] != "Pickup") {
                        ...
                        <?php if (isset($order_list[0]['order_delivery_charge']) && $order_list[0]['order_delivery_charge'] != '' && $order_list[0]['order_delivery_charge'] > 0) { ?>
                            <tr bgcolor="#f3f3f3">
                                ...
                                <td colspan="1" style="    color: #000;	font-family: arial, sans-serif;	font-size: 12px;	padding: 7px;	text-align: right; font-weight:600;border: 1px solid #b5b5b5;"><strong><?php echo show_price($order_list[0]['order_delivery_charge']); ?></strong></td>
                            </tr>
                    ...
                    <tr bgcolor="#f3f3f3">
                            ...
                            <td colspan="1" style="    color: #000;	font-family: arial, sans-serif;	font-size: 12px;	padding: 7px; text-align: right; font-weight:600;border: 1px solid #b5b5b5;"><strong><?php echo show_price($order_list[0]['order_discount_amount']); ?></strong></td>
                    </tr>
                    <?php } ?> 
                ...
                <tr bgcolor="#f3f3f3">
                    ...
                    <td valign="top" colspan="1" style="  color: #000;	font-family: arial, sans-serif;	font-size: 12px; text-align: right; font-weight:600;border: 1px solid #b5b5b5;">
                        <strong><?php echo show_price($order_list[0]['order_total_amount']); ?></strong></td>
