...
class Outlets extends REST_Controller
{
	...
	public function outletaddedit($outlet_id = null)
	{
		...
		$Itemarray = array(
			...
			'outlet_province'		=> post_value('outlet_province'),
			'outlet_city'			=> post_value('outlet_city'),
			'outlet_district'		=> post_value('outlet_district'),
			'outlet_village'		=> post_value('outlet_village'),
			'outlet_marker_latitude' => post_value('outlet_marker_latitude'),
			'outlet_marker_longitude' => post_value('outlet_marker_longitude'),
			'outlet_postal_code'	=> post_value('outlet_postal_code'),
			'outlet_country'		=> post_value('outlet_country'),
