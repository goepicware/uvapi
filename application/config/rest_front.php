...
// Frontend
$config['auth_override_class_method']['guestaccount']['guest_customer_phone'] = 'none';
$config['auth_override_class_method']['guestaccount']['check'] = 'none';
$config['auth_override_class_method']['guestaccount']['create'] = 'none';
$config['auth_override_class_method']['products']['*'] = 'none';
$config['auth_override_class_method']['cart']['*'] = 'none';
$config['auth_override_class_method']['cms']['*'] = 'none';
$config['auth_override_class_method']['outlets']['*'] = 'none';
$config['auth_override_class_method']['settings']['*'] = 'none';
$config['auth_override_class_method']['newsletter']['*'] = 'none';
$config['auth_override_class_method']['contactus']['*'] = 'none';
$config['auth_override_class_method']['country']['*'] = 'none';
$config['auth_override_class_method']['menu']['*'] = 'none';
$config['auth_override_class_method']['customer']['resend_otp'] = 'none';
$config['auth_override_class_method']['customer']['customer_otp_verification'] = 'none';
$config['auth_override_class_method']['customer']['send_customer_otp'] = 'none';
...
|
*/
$config['rest_keys_table'] = 'pos_keys';
...
$config['rest_frontend_limit'] = 10;
$config['rest_backend_limit'] = 10;
