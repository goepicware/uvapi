...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyCbRG0REStInVtlJTGTpjzBUR4fFTQ7OWg';	// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
		...
		if ($polygon['editable']!="") { 
			...
			$polygon_output .= '
					google.maps.event.addListener(polygon_'.count($this->polygons).'.getPath(), "set_at", function() {
						...
						setTimeout(function(){ updateMapData(); }, 1000);
					});
	...
	function create_map()
	{
      ...
      function deleteSelectedShapeNew(mapid,mapname) {
          if (selectedShape) {
			  if (confirm('Are you sure want to remove this?') == true) {
					selectedShape.setMap(null);
					document.getElementById('region_type'+mapname).value='';
