...
class Foodpanda_test
{
                                ...
                                foreach (
                                    ...
                                    (object) [
                                        ($list[
                                            ...
                                            "description" => (object) [
                                                "default" =>
                                                    $produ["product_short_description"],
                                            ],
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        $itemlist["items"][
                                            ...
                                            // ),
                                            "variants" => array("var".$produ["product_primary_id"] => array("id" => "var".$produ["product_primary_id"], "type" => "Product" )),
                                            "images" => [
                                                "image-" . $imgid => [
                                                    "id" => "image-" . $imgid,
                                                    "type" => "Image",
                                      ...
                                      $itemlist["items"]["var".$produ["product_primary_id"]] =  array ( 'id' => "var".$produ["product_primary_id"],
                                                        'title' => 
                                                        array (
                                                          'default' => 'Regular',
                                                        ),
                                        ...
                                        if (!empty($produ["set_menu_component"])  ) {
                                            ...
                                            foreach (
                                                ...
                                                $itemlist["items"][
                                                    ...
                                                    "isExpressItem" => false,
                                                    "excludeDishInformation" => false,
                                                    // "toppings" => $this->getModifierMofierval($app_id, $produ['product_id'], $mod['id'])
                                                    "toppings" => [
                                                        "tt" . $mod["id"] => [
                                                            "id" =>
                                                                "tt" .
    ...
    public function dispatch_menu($app_id, $compid, $food_panda_outlet)
    {
        $jsonStr = [];
       ...
       // $chaincodee = "ninjaos_sg";
        ...
        if (!empty($outletInfo)) {
            ...
            foreach ($outletInfo as $outlet) {
                ...
                $json_array["catalog"] = $this->getComplexItems($outlet["outlet_id"],$app_id,$compid);

                $json_array["vendors"] = [
                                0 => "9999"
                                  ];
                $json_array["callbackUrl"] = "https://webhook.site/3ed0611f-8a83-482b-816c-51c479c19a2e";
