...
$configArray["merchantId"] = "TEST001500074056";
// example
// $configArray["merchantId"] = "001500012345"; 



// API username in the format below where Merchant ID is the same as above
$configArray["apiUsername"] = "Merchant.TEST001500074056";
// example
//$configArray["apiUsername"] = "Merchant.001500012345";


// API password which can be configured in Merchant Administration


$configArray["password"] = "eacdaf0aa1cd9b74853f9924a806f66f";

// example
//$configArray["password"] = "1a366dec37909d19098865569aef5962";
